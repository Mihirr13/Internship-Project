    ...
    return (
      <div style={{ color: "skyblue" }}>
        ...
        <form onSubmit={handleSubmit(submithandler)}>
          ...
          <div>
            <label>Hobbies :</label>{" "}
                <input type='checkbox'  {...register("hobby",validationSchema.hobbyValidator)}></input>Cricket
                <input type='checkbox'  {...register("hobby",validationSchema.hobbyValidator)}></input>BGMI
                <input type='checkbox'  {...register("hobby",validationSchema.hobbyValidator)}></input>Valorant
                <input type='checkbox'  {...register("hobby",validationSchema.hobbyValidator)}></input>Music
